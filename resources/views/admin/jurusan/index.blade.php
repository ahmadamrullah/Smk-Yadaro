            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            @foreach ($jurusan as $jrs => $hasil)
                                <tr>
                                    <td>{{ $jrs + $jurusan->firstitem() }}</td>
                                    <td>{{ $hasil->kd_jurusan }}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('jurusan.destroy', $hasil->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('jurusan.edit', $hasil->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit "></i> Edit</a>
